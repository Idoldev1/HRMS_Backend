        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHours = table.Column<decimal>(type: "decimal(7,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedById = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimesheetAuditLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimesheetAuditLogs_Timesheets_TimesheetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasksCompleted = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetAuditLogs_TimesheetId",
                table: "TimesheetAuditLogs",
                column: "TimesheetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_EmployeeId_Month_Year",
                table: "Timesheets",
